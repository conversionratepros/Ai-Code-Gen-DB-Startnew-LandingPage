(function() {
    ...
    const styles = `
        ...
        .hp-reviewer-initials {
            width: 40px;
            height: 40px;
            border-radius: 50%;
            background-color: #25B888;
            color: #fff;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .hp-toggle-reviews-btn {
            margin-top: 30px;
            padding: 10px 20px;
            border: 1px solid #25B888;
    ...
    function handleToggle() {
        ...
        btn.addEventListener('click', () => {
            ...
            reviews.forEach((review, index) => {
                if (index >= 3) {
                    // Toggle hidden class based on expansion state
                    if (isExpanded) {
